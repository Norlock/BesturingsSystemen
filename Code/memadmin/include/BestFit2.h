...
/** @file BestFit2.h
 *  @brief The class that implements the eager version of the BestFit2 algorithm.
 *  @author Joris,Gijs
...
/// op adres)
class	BestFit2 : public FirstFit
{
public:
	...
	BestFit2(bool cflag=false, const char *type = "FirstFit (eager)")
		: FirstFit(cflag, type) {}
